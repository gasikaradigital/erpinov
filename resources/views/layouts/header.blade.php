          ...
          <div class="container-fluid">
            <div class="row justify-content-center">
              <div class="col-xl-10 d-flex align-items-center">
                <h1 class="logo mr-auto"><a href="index.html">ERPINNOV<span>.</span>COM</a></h1>
                ...
                <a href="{{ route('login') }}" class="get-started-btn scrollto" target="_blank">Votre espace client</a>
              </div>
            </div>
        ...
        <footer id="footer">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                  <h3>Erpinnov<span>.</span>com</h3>
                  <p>
                    Plateau de tombe <br>
                    Mahajanga ville 401<br>
                    Madagascar <br><br>
                    <strong>Phone:</strong> +261 34 93 452 51<br>
                    <strong>Email:</strong> Contact@gasikara.mg<br>
                  </p>
                </div>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                  ...
                  <ul>
                    ...
                    <li><i class="bx bx-chevron-right"></i> <a href="{{ url('/tarif') }}">Tarif</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="{{ url('/blog') }}">Blog</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="{{ url('/faq') }}">FAQ'S</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                  <h4>Aides</h4>
                  <ul>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Dolibarr ERP CRM</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Documentation</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Tutoriels vidéos</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Statut des services</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Espace client</a></li>
                  </ul>
                </div>
          ...
          <div class="container d-md-flex py-4">
            ...
            <div class="mr-md-auto text-center text-md-left">
              <div class="copyright">
                &copy; <strong><span>ERPINNOV</span></strong>.com GASIKARA DIGITAL
              </div>
              <div class="credits">
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Accueil</h2>
